...
export const foods: Food[] = [
  ...
  { id: 'white-rice', name: 'White Rice (cooked)', calories: 206, protein: 4.3, carbs: 45, fat: 0.4, servingSize: '1 cup' },
  ...
  { id: 'oats', name: 'Oats (rolled, dry)', calories: 150, protein: 5, carbs: 27, fat: 3, servingSize: '1/2 cup' },
  { id: 'broccoli', name: 'Broccoli', calories: 31, protein: 2.5, carbs: 6, fat: 0.3, servingSize: '1 cup' },
  { id: 'salmon', name: 'Salmon', calories: 208, protein: 22, carbs: 0, fat: 13, servingSize: '100g' },
  ...
  { id: 'ground-beef', name: 'Ground Beef (85% lean)', calories: 215, protein: 21, carbs: 0, fat: 14, servingSize: '100g' },
  { id: 'milk', name: 'Milk (2%)', calories: 122, protein: 8, carbs: 12, fat: 4.8, servingSize: '1 cup' },
  { id: 'cheddar-cheese', name: 'Cheddar Cheese', calories: 113, protein: 7, carbs: 0.4, fat: 9, servingSize: '28g' },
  ...
  { id: 'tuna', name: 'Tuna (canned, in water)', calories: 99, protein: 22, carbs: 0, fat: 0.7, servingSize: '100g' },
  { id: 'quinoa', name: 'Quinoa (cooked)', calories: 222, protein: 8, carbs: 39, fat: 3.6, servingSize: '1 cup' },
  { id: 'walnuts', name: 'Walnuts', calories: 185, protein: 4.3, carbs: 3.9, fat: 18, servingSize: '28g (14 halves)' },
];
